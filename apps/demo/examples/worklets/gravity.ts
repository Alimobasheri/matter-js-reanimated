        ...
        case 0:
          if (global.MatterReanimated.Common.random() < 0.8) {
            return Bodies.rectangle(
              x,
              y,
              global.MatterReanimated.Common.random(20, 50) * scale,
              global.MatterReanimated.Common.random(20, 50) * scale
            );
          } else {
            return Bodies.rectangle(
              ...
              global.MatterReanimated.Common.random(20, 30) * scale
            );
          }
        case 1:
          return Bodies.polygon(
            x,
            y,
            Math.round(global.MatterReanimated.Common.random(1, 8)),
            global.MatterReanimated.Common.random(20, 50) * scale
          );
      }
    }
