...
declare namespace MatterReanimated {
    /**
     * Installs the given plugins on the `MatterReanimated` namespace.
    ...
    /**
     * The `MatterReanimated.Axes` module contains methods for creating and manipulating sets of axes.
     */
    export class Axes {
        /**
    ...
    export class Bodies {
         ...
         * The options parameter is an object that specifies any `MatterReanimated.Body` properties you wish to override the defaults.
         * See the properties section of the `MatterReanimated.Body` module for detailed information on what you can pass via the `options` object.
         * @method fromVertices
         * @param {number} x
         * @param {number} y
    ...
    export interface IBodyDefinition {
         ...
         * It is used and updated by the `MatterReanimated.Sleeping` module during simulation to decide if a body has come to rest.
         *
         * @readOnly
         * @default 0
         */
        ...
        /**
         * A `Number` that defines the number of updates in which this body must have near-zero velocity before it is set as sleeping by the `MatterReanimated.Sleeping` module (if sleeping is enabled by the engine).
         *
         * @default 60
         */
         ...
         * Concave hulls are not currently supported. The module `MatterReanimated.Vertices` contains useful methods for working with vertices.
         */
    ...
    /**
     * The `MatterReanimated.Body` module contains methods for creating and manipulating body models.
     * A `MatterReanimated.Body` is a rigid body that can be simulated by a `MatterReanimated.Engine`.
     * Factories for commonly used body configurations (such as rectangles, circles and other polygons) can be found in the module `MatterReanimated.Bodies`.
     *
     * See the included usage [examples](https://github.com/liabru/matter-js/tree/master/examples).
     */
    export class Body {
    ...
    export interface ICompositeDefinition {
         ...
         * Most `MatterReanimated.Composite` methods will automatically set this flag to `true` to inform the engine of changes to be handled.
    ...
    /**
     * The `MatterReanimated.Composite` module contains methods for creating and manipulating composite bodies.
     * A composite body is a collection of `MatterReanimated.Body`, `MatterReanimated.Constraint` and other `MatterReanimated.Composite`, therefore composites form a tree structure.
     * It is important to use the functions in this module to modify composites, rather than directly modifying their properties.
     * Note that the `MatterReanimated.World` object is also a type of `MatterReanimated.Composite` and as such all composite methods here can also operate on a `MatterReanimated.World`.
     *
     * See the included usage [examples](https://github.com/liabru/matter-js/tree/master/examples).
     */
    ...
    export interface IEngineDefinition {
         ...
         *
         * @default {MatterReanimated.Detector} instance
         */
        detector?: Detector;
         ...
         *
         * @default {MatterReanimated.World} instance
         */
        world?: World;
    ...
    export class Engine {
         ...
         * A `World` composite object that will contain all simulated bodies and constraints.
         *
         * @default a MatterReanimated.World instance
         */
        world: World;
    }
    ...
    export interface IRenderDefinition {
        /**
         * A back-reference to the `MatterReanimated.Render` module.
         */
        controller?: any;
        /**
         * A reference to the `MatterReanimated.Engine` instance to be used.
         */
        engine: Engine;
        /**
    ...
    /**
     * The `MatterReanimated.Svg` module contains methods for converting SVG images into an array of vector points.
     *
     * See the included usage [examples](https://github.com/liabru/matter-js/tree/master/examples).
     */
    export class Svg {
    ...
    /**
     * The `MatterReanimated.World` module contains methods for creating and manipulating the world composite.
     * A `MatterReanimated.World` is a `MatterReanimated.Composite` body, which is a collection of `MatterReanimated.Body`, `MatterReanimated.Constraint` and other `MatterReanimated.Composite`.
     * A `MatterReanimated.World` has a few additional properties including `gravity` and `bounds`.
     * It is important to use the functions in the `MatterReanimated.Composite` module to modify the world composite, rather than directly modifying its properties.
     * There are also a few methods here that alias those in `MatterReanimated.Composite` for easier readability.
     *
     * See the included usage [examples](https://github.com/liabru/matter-js/tree/master/examples).
     */
    ...
    export class Plugin {
         ...
         * For installing plugins on `MatterReanimated` see the convenience function `MatterReanimated.use`.
