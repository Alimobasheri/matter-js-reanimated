...
exports.initAvalanche = void 0;
const initAvalanche = engine => {
  'worklet';
  ...
  World.add(engine.world, [Bodies.rectangle(width * 0.25, height * 0.25, width * 0.875, 20, {
    isStatic: true,
    angle: Math.PI * 0.06
...
exports.initAvalanche = initAvalanche;
